...
```
Of the 454 GATA1 peaks, 424 (93.39%) contain a motif

of the 938 motif instances found all 100% overlap with a peak of the GATA1 ChIP


```{r, eval=FALSE}

moi_genome <- findMotifInstances(genome2, motif, mc.cores=1)
```
